//! Composition root for the Family bounded context.
...
use family_application::{AddMember, CreateFamily, GetFamily, ListFamiliesForUser, ListMembers};
use family_infrastructure::PostgresFamilyRepository;
use family_presentation::{
    FamilyServices,
    mcp::{FamilyMcp, JsonRpcRequest, JsonRpcResponse},
};
...
async fn main() -> Result<()> {
    ...
    let services = FamilyServices {
        ...
        list_for_user: Arc::new(ListFamiliesForUser::new(repo)),
    };
