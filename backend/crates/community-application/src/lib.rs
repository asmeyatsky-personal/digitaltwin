...
impl CreateGroup {
    ...
    pub async fn execute(
        &self,
        i: CreateGroupInput,
    ) -> Result<EntityId<CommunityGroup>, UseCaseError> {
        let now = self.clock.now();
        let id = EntityId::<CommunityGroup>::new();
        let g = CommunityGroup::new(
            id,
            i.name,
            i.description,
            i.category,
        ...
        self.audit
            .append(AuditEvent {
                ...
                entity_type: "CommunityGroup".into(),
                entity_id: id.to_string(),
                before_hash: String::new(),
                after_hash: hash_state(&g),
            })
            .await?;
        Ok(id)
    }
...
impl ListGroups {
    ...
    pub async fn execute(
        ...
        limit: u32,
    ) -> Result<Vec<CommunityGroup>, UseCaseError> {
...
impl CreatePost {
    ...
    pub async fn execute(
        &self,
        i: CreatePostInput,
    ) -> Result<EntityId<CommunityPost>, UseCaseError> {
        let now = self.clock.now();
        ...
        self.audit
            .append(AuditEvent {
                ...
                entity_type: "CommunityPost".into(),
                entity_id: id.to_string(),
                before_hash: String::new(),
...
impl ListPosts {
    ...
    pub async fn execute(
        ...
        group_id: EntityId<CommunityGroup>,
        limit: u32,
    ) -> Result<Vec<CommunityPost>, UseCaseError> {
