// Mobile client for the Rust identity-service. Same JSON REST shape as the
// web client; request/response types come from the Protobuf-generated TS.
...
const IDENTITY_URL =
  process.env.EXPO_PUBLIC_IDENTITY_URL ?? "http://localhost:8080";
